...
bot = Bot(token='6348745076:AAH1DDx_tubosIDPOdlpOm5beqgPkkpbCDg')   # REPLACE YOUR TELEGRAM BOT TOKEN HERE
dp = Dispatcher(bot)

API_KEY = "Us6Fwm_H6zhmOw2kDNQgNULsQQh-xR4TRloGlXyrARXrf_x2"   # REPLACE YOUR REMINI API KEY THAT HAS CREDITS
